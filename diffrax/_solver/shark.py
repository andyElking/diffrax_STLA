...
from .srk import AbstractSRK, AdditiveSpaceTimeLACoeffs, StochasticButcherTableau


cfs_bm = AdditiveSpaceTimeLACoeffs(
    a_w=np.array([0.0, 5 / 6]),
    b_w=np.array(1.0),
    a_hh=np.array([1.0, 1.0]),
    b_hh=np.array(0.0),
)
