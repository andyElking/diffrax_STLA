...
from .._custom_types import BrownianIncrement, RealScalarLike
from .._path import AbstractPath


_Control = TypeVar("_Control", bound=Union[PyTree[Array], BrownianIncrement])


class AbstractBrownianPath(AbstractPath[_Control]):
    """Abstract base class for all Brownian paths."""

    levy_area: AbstractVar[type[BrownianIncrement]]
